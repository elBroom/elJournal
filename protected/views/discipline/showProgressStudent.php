...
<div class="form">
	<div class="row">
        <?php echo CHtml::dropDownList('Discipline_title','', DisciplineToUser::model()->allForStudent()); ?>
    </div>
</div>

<div id="showProgress">
<?php $this->renderPartial('_progressAttendanceStudent', array(
                'model' => $model,
                'criteriaAttendance' => $criteriaAttendance,
                ));?>
<?php $this->renderPartial('_progressEstimateStudent', array(
                'model' => $model,
