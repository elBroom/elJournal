 ...
 * @property Specialty $idSpecialty
...
class Student extends CActiveRecord
{
	...
	{
		return array(
			array('id_specialty, year_income', 'required'),
			array('id_user, id_specialty', 'numerical', 'integerOnly'=>true),
			array('year_income', 'length', 'max'=>4),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_student, id_user, id_specialty, year_income', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idSpecialty' => array(self::BELONGS_TO, 'Specialty', 'id_specialty'),
