...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username', 'match', 'pattern' => '/^([a-zA-Z0-9_]+)$/u', 'message' => 'Допустимые символы: a-z,A-Z,0-9,_'),
			array('email', 'email'),
			array('ban, role', 'numerical', 'integerOnly'=>true),
			array('username, password, email', 'length', 'max'=>255),
			array('created, ban, role', 'safe'),
